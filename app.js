document.addEventListener('DOMContentLoaded', () => {
    ...
    function formatTime(isoString) {
        // Trello provides timezone-UTC strings like: 2025-06-08T12:37:00Z
        // Transform purely matching Python's Taiwan timezone shift logic (+8 hours strictly if desired)
        const dt = new Date(isoString);
        // By relying on dt.getTimezoneOffset(), it inherently uses system local timezone. 
        // For standard local time rendering (which is actually best for a web browser app):
    ...
    function generatePrintableHTMLAndOpen(selectedListIds) {
        ...
        // Map Comments
        // Only target commentCard/copyCommentCard
        ...
        selectedListIds.forEach(listId => {
            ...
            listCards.forEach((card, i) => {
                // Parse markdown synchronously! No need to inject marked.js CDN in the print result anymore!
        ...
        htmlContent += `
        <script>
            // Optionally wait a second and trigger print screen automatically
        ...
        // Trigger opening in a new tab securely using Object URL Blob
